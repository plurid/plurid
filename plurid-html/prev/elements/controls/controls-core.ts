...
export function renderControls(element: any, id: any) {
...
export function setControls(element: any) {
...
function setActivePlurid(element: any) {
    const pluridSelect = element.getElementsByClassName("plurid-controls-select")[0];

    pluridSelect.addEventListener("click", (event: MouseEvent) => {
...
function goToParent(element: any) {
    ...
    if (bridge.nodeName === "PLURID-BRIDGE") {
        pluridParent.addEventListener('click', (event: MouseEvent) => {
...
function minimizeSelectedSheet(element: any) {
    ...
    pluridMinimize.addEventListener('click', (event: MouseEvent) => {
...
function reduceSelectedSheet(element: any) {
    const pluridReduce = element.getElementsByClassName("plurid-controls-reduce-height")[0];
    const pluridMinimize = element.getElementsByClassName("plurid-controls-minimize")[0];


    pluridReduce.addEventListener('click', (event: MouseEvent) => {
        const sheet = element.parentElement;
        const sheetChildren = (<any> window).pluridScene.getChildrenBySheetId(sheet.id);
 ...
 */
function toggleChildren(sheetChildren: any): any {
...
function closePlurid(element: any) {
    const pluridParentClose = element.getElementsByClassName("plurid-controls-close")[0];

    pluridParentClose.addEventListener("click", (event: MouseEvent) => {
        const sheet = element.parentElement;
        const sheetChildren = (<any> window).pluridScene.getChildrenBySheetId(sheet.id);
 ...
 * @param {Array} sheetChildren
 */
function removeChildren(pluridRoot: any, children: any): any {
    if (children) {
...
function reloadPlurid(element: any) {
    ...
    pluridReload.addEventListener('click', (event: MouseEvent) => {
...
function extendBridge(element: any) {
...
function searchPlurid(element: any) {
    ...
    function setSearchLink(branchLink: any, _pluridSearchInput: any) {
    ...
    pluridSearch.addEventListener('click', (event: MouseEvent) => {
        search(pluridSearchInput.value, sheet);
    });

    pluridCancelSearch.addEventListener('click', (event: MouseEvent) => {
        clearSearch(pluridSearchInput);
    });

    pluridSearchInput.addEventListener('keydown', (event: KeyboardEvent) => {
        if (event.key === "Escape") {
            clearSearch(pluridSearchInput);
        }
    ...
    function clearSearch(searchInput: any) {
        searchInput.value = "";
        searchInput.focus();
    }

    function search(url: any, _sheet: any) {
        if (!url) {
            const message = "Nothing to search for.";
            setControlsMessage(element, message);
        } else {
            const sheetChildren = (<any> window).pluridScene.getChildrenBySheetId(_sheet.id);
...
function getPage(url: any, sheet: any, element: any) {
...
function opacityPlurid(element: any) {
    ...
    function setOpacity(event: any, _sheet: any, _pluridOpacity: any) {
...
function morePlurid(element: any) {
    ...
    pluridMore.addEventListener('click', (event: Event) => {
...
function openCloseControls(element: any) {
    ...
    pluridControlsOpenCloseCharacter.addEventListener("click", (event: Event) => {
...
function setControlsMessageClose(element: any) {
    ...
    pluridMessageClose.addEventListener("click", (event: Event) => {
...
function setControlsMessage(element: any, message: any) {
    const pluridMessage = element.getElementsByClassName("plurid-controls-message")[0];
    const pluridMessageContent = element.getElementsByClassName("plurid-controls-message-content")[0];
