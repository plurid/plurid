...
"use strict";
eval("\n\nvar _containerCore = __webpack_require__(/*! ./container-core */ \"./src/js/source/elements/container-core.js\");\n\nvar _options = __webpack_require__(/*! ./options */ \"./src/js/source/elements/options.js\");\n\nvar _shortcuts = __webpack_require__(/*! ../logic/shortcuts */ \"./src/js/source/logic/shortcuts.js\");\n\nvar _optionsCore = __webpack_require__(/*! ./options-core */ \"./src/js/source/elements/options-core.js\");\n\nvar _utils = __webpack_require__(/*! ./element-utils/utils */ \"./src/js/source/elements/element-utils/utils.js\");\n\nclass PluridContainer extends HTMLElement {\n    constructor() {\n        super();\n    }\n\n    connectedCallback() {\n        (0, _utils.setId)(this, 'container');\n\n        (0, _containerCore.transform)(this);\n\n        (0, _options.initOptions)(this);\n        (0, _optionsCore.renderOptions)(this);\n        (0, _optionsCore.displayOptions)(this);\n\n        (0, _shortcuts.initShortcuts)(this);\n    }\n}\n\ncustomElements.define('plurid-container', PluridContainer);\n\n//# sourceURL=webpack:///./src/js/source/elements/container.js?");
