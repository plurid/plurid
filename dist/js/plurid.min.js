...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"transform\", function() { return transform; });\n/* harmony import */ var _logic_get_plurid_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../logic/get-plurid.js */ \"./src/js/source/logic/get-plurid.js\");\n/* harmony import */ var _logic_style_plurid_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../logic/style-plurid.js */ \"./src/js/source/logic/style-plurid.js\");\n/* harmony import */ var _logic_transforms_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../logic/transforms.js */ \"./src/js/source/logic/transforms.js\");\n\n\n\n\n// transform receives the selected plurid\nfunction transform(element) {\n    let pluridStack = new Set();\n    let plurid = document.querySelector(\"plurid-roots\");\n\n    // element.addEventListener(\"click\", event => {\n    //     let pluridRoot = getPlurid(event).root;\n    //     let pluridSheet = getPlurid(event).sheet;\n    //     // console.log(\"PLURID ROOT \", pluridRoot);\n    //     // console.log(\"PLURID SHEET\", pluridSheet);\n\n    //     pluridStack.add(pluridRoot);\n    //     plurid = style(pluridRoot, pluridStack);\n    // });\n\n    element.addEventListener('wheel', event => {\n        if(event.shiftKey) {\n            event.preventDefault();\n\n            Object(_logic_transforms_js__WEBPACK_IMPORTED_MODULE_2__[\"rotatePlurid\"])(event, plurid);\n        }\n\n        if(event.altKey) {\n            event.preventDefault();\n\n            Object(_logic_transforms_js__WEBPACK_IMPORTED_MODULE_2__[\"translatePlurid\"])(event, plurid);\n        }\n\n        if(event.metaKey) {\n            event.preventDefault();\n\n            Object(_logic_transforms_js__WEBPACK_IMPORTED_MODULE_2__[\"scalePlurid\"])(event, plurid);\n        }\n    });\n}\n\n\n//# sourceURL=webpack:///./src/js/source/elements/container-core.js?");

/***/ }),

/***/ "./src/js/source/elements/container.js":
/*!*********************************************!*\
  !*** ./src/js/source/elements/container.js ***!
  \*********************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _container_core_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./container-core.js */ \"./src/js/source/elements/container-core.js\");\n/* harmony import */ var _options_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./options.js */ \"./src/js/source/elements/options.js\");\n/* harmony import */ var _logic_shortcuts_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../logic/shortcuts.js */ \"./src/js/source/logic/shortcuts.js\");\n/* harmony import */ var _branch_core_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./branch-core.js */ \"./src/js/source/elements/branch-core.js\");\n/* harmony import */ var _options_core_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./options-core.js */ \"./src/js/source/elements/options-core.js\");\n\n\n\n\n\n\n\n\nvar pluridContainer = Object.create(HTMLElement.prototype, {\n    createdCallback: {\n        value: function() {\n            Object(_container_core_js__WEBPACK_IMPORTED_MODULE_0__[\"transform\"])(this);\n\n            Object(_options_js__WEBPACK_IMPORTED_MODULE_1__[\"initOptions\"])()\n            Object(_options_core_js__WEBPACK_IMPORTED_MODULE_4__[\"renderOptions\"])(this);\n            Object(_options_core_js__WEBPACK_IMPORTED_MODULE_4__[\"displayOptions\"])(this);\n\n            Object(_logic_shortcuts_js__WEBPACK_IMPORTED_MODULE_2__[\"initShortcuts\"])(this);\n\n            Object(_branch_core_js__WEBPACK_IMPORTED_MODULE_3__[\"renderBranch\"])();\n\n        }\n    }\n});\n\ndocument.registerElement( \"plurid-container\", {\n    prototype: pluridContainer\n});\n\n\n//# sourceURL=webpack:///./src/js/source/elements/container.js?");

/***/ }),

/***/ "./src/js/source/elements/content.js":
/*!*******************************************!*\
  !*** ./src/js/source/elements/content.js ***!
  \*******************************************/
/*! no static exports found */
...
eval("/* WEBPACK VAR INJECTION */(function(global) {// set pluridScene as global variable\n\n(function (global) {\n    global.pluridScene = {\n        metadata: {\n            pages: 0\n        },\n        content: {}\n    }\n}).call(this, global)\n\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../node_modules/webpack/buildin/global.js */ \"./node_modules/webpack/buildin/global.js\")))\n\n//# sourceURL=webpack:///./src/js/source/state/plurid-scene.js?");
