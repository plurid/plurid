...
const english: Internationalization = {
    viewcubeFront: 'front',
    viewcubeBack: 'back',
    viewcubeLeft: 'left',
    viewcubeRight: 'right',
    ...
    toolbarDrawerThemesTitle: 'themes',
    toolbarDrawerThemesGeneralTheme: 'general theme',
    toolbarDrawerThemesInteractionTheme: 'interaction theme',
    toolbarDrawerThemesLanguage: 'language',
