...
const romanian: Internationalization = {
    ...
    toolbarDrawerTransformAllowRotationY: 'permite rotație y',
    ...
    toolbarDrawerSpaceTransparentUserInterface: 'interfață transparentă',
    toolbarDrawerSpaceShowTransformOrigin: 'arată originea transformării',
    toolbarDrawerSpaceTransformOriginSize: 'mărimea originii',
    ...
    toolbarDrawerToolbarAlwaysOpaque: 'mereu opacă',
    ...
    toolbarDrawerToolbarConcealToolbar: 'ascunde bara',
    ...
    toolbarDrawerShortcutsScaleUp: 'mărire',
    toolbarDrawerShortcutsScaleDown: 'micșorare',
    ...
    toolbarDrawerShortcutsRefreshPlane: 'reîmprospătare plan',
    toolbarDrawerShortcutsIsolatePlane: 'izolare plan',
    ...
    toolbarDrawerShortcutsArrowOrScrollUp: '↑ sau derulare sus',
