...
function usage(): void {
    process.stdout.write(
        [
            ...
            '',
            'Commands:',
            '  dev      Start the dev server (esbuild client+server; --watch rebuilds and restarts the server on change)',
            ...
            '  --watch        (dev) rebuild the bundles on change; the server restarts on server changes (refresh the browser for client changes)',
