...
const PluridView: React.FC<PluridViewProperties> = (
    ...
    // #region effects
        ...
        // The effect only registers `treeUpdateCallback`, so depend on the callback itself —
        // its own deps already track view/config/tree. This drops two per-render whole-tree/
        // whole-config `JSON.stringify`s that recomputed the exact same trigger.
        }, [
            treeUpdateCallback,
        ]);
