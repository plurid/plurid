 ...
 * drawn for a child that has been moved by hand or hangs as a later sibling
 * of a fan — IS THE BRIDGE, drawn as a beam: the band's own height
 * (`BRIDGE_STRIP_HEIGHT`), centred on the link's line, so its top is the
 * plane's top exactly as the strip's is, with straight ends. It was thinned to
 * 6px once (2026-09-14, "an opaque slab across the space"); the user's rule
 * (2026-09-17) is that a bridge looks like a bridge whatever its length, and a
 * thin rounded line beside a flat band read as two different things.
 */
const THICKNESS = 3;
