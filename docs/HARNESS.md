...
| `columns-read` | Columns, a plane read as a page — The space presentation with GEOMETRY docked through the rail: the plane fills the view at its fill scale, the chrome hides, the other planes are set aside. | - | `⌂ /geometry` | `front` | planes: 5, minimap: false, overlap: expected |
