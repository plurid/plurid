...
- ON A PAGE A LINK IS A LINK (2026-09-06): in the page presentation `toggleLinkPlane` never closes — a click on an open link navigates to its page (the Alt-click path); the space presentation keeps the toggle.
