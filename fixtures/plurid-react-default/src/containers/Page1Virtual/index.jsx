...
const renderData = () => {
    ...
    for (let i = 0; i < 1000; i++) {
        const el = (
            ...
            >
                <b>row {i}</b> - {text.repeat(Math.floor(1 + Math.random() * 5))}
            </div>
        );
        data.push(el);
    }
