...
export const FIXTURES: readonly FixtureDefinition[] = [
    ...
    { name: 'columns-read', title: 'Columns, a plane read as a page', description: 'The space presentation with GEOMETRY docked through the rail: the plane fills the view at its fill scale, the chrome hides, the other planes are set aside.', query: {}, steps: [{ kind: 'dock', plane: '/geometry' }], viewpoints: [FRONT], expect: { planes: 5, minimap: false, overlap: 'expected' } },
